                ...
                <div >
                  ...
                  <div class="item-comm">
                    ...
                    <div  class="comm-b">
                      ...
                      <div class="r" >
                        <p v-if="detailList.commissionJunction != null" v-for="i in detailList.commissionJunction">{{i}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="item-sell" v-if="detailList.sellingPoint != null">
                    <div>
                      <div class="pro-sell">
                        项目卖点
                      </div>
                  ...
                  <div class="item-photo"  v-if="detailList.propertyAlbum!= null">
                      ...
                      <div  class="photo-list" v-for="s in detailList.propertyAlbum2" >
                        <img  v-lazy="s.data" alt="">
                      </div>
                  </div>
                  <div class="item-photo" v-if="detailList.huxingImg != null">
                      ...
                      <div class="photo-list" v-for="(i,index) in detailList.huxingImg" :key="index">
                        <img v-if="id===0" v-lazy="i.data" alt="">
                        <img v-if="id===1" v-lazy="'http://sofmanager.fangsir007.com/image/' + i" alt="">
                      </div>
                  </div>
